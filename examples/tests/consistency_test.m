...
prams.T = 3e-2;                  % time horizon
prams.m = 3;                % number of time steps
...
prams.viscCont = 5;            % viscosity contrast
...
fprintf(['Final position difference between refactor version and original version: ' num2str(norm(Xfinal(:)-XfinalCol(:))) '.\n']);
% Run vesicle code
