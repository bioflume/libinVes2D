%function [Xfinal] = chokeTraffic(N,m,Nbd,viscCont,vesves,orderGL,nsdc,saveData,resolveCol,minSep)
%N =64;m =3000;viscCont = 10;vesves = 'explicit';orderGL=2;nsdc=0;saveData=0;resolveCol=0;minSep=0;Nbd = 512;
warning off;
...
% options.restartFile = 'flowchokeN64nv80Nbd1024ts0.02visc10order1explicitinterpGLorder3nsdc1resolveCol1minSep1withfmmwithnear.bin';
