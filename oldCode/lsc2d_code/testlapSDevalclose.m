...
a = 1*(.1); w = 5;         % smooth wobbly radial shape params
...
s.inside = @(z) abs(z)<R(angle(z)); s.a = 0*(-.1+.2i);  % interior pt far from bdry
N = 32; s = quadr(s,N); % set up nodes on bdry (note outwards normal)
